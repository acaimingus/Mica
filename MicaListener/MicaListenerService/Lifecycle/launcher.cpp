 ...
 *
 * Description: Launcher implementation for setting up the listener service and starting it.
 */
...
void Launcher::Launch()
{
    ...
    while (!ShutdownHandler::ShouldShutdown())
    {
        ...
        {
            std::clog << logName << "Device '" << config.GetDeviceName() << "' rejected or timed out. Blacklisting..."
                      << std::endl;
