...
class ServiceDiscovery
{
  ...
  private:
    ...
    static void BrowseCallback(AvahiServiceBrowser *_browser, AvahiIfIndex _interface, AvahiProtocol _protocol,
                               ...
                               const char *_domain, AvahiLookupResultFlags _flags, void *_userData);
    ...
    static void ResolveCallback(AvahiServiceResolver *_resolver, AvahiIfIndex _interface, AvahiProtocol _protocol,
                                AvahiResolverEvent _event, const char *_name, const char *_type, const char *_domain,
                                const char *_hostName, const AvahiAddress *_address, uint16_t _port,
                                AvahiStringList *_text, AvahiLookupResultFlags _flags, void *_userData);
