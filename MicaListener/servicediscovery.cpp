...
namespace MicaListener
{
    ...
    {
    public:
        ServiceDiscovery(std::string _serviceName) : serviceName(_serviceName)
        {
    ...
    private:
        ...
        {
            void operator()(AvahiSimplePoll *_simplePoll)
            {
        ...
        {
            void operator()(AvahiClient *_client)
            {
        ...
        {
            void operator()(AvahiServiceBrowser *_browser)
            {
        ...
        {
            void operator()(AvahiServiceResolver *_resolver)
            {
        ...
        void CreateServiceResolver(AvahiClient *_client, AvahiIfIndex _interface, AvahiProtocol _protocol, const char *_name, const char *_type, const char *_domain)
        {
        ...
        void HandleResolverState(AvahiResolverEvent _event, const char *_name, const AvahiAddress *_address, uint16_t _port)
        {
            switch (_event)
            {
